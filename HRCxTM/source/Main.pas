...
type
  ...
  private
    ...
    const headerstring = 'CDF.HRC_ID,CREDIT_LIMIT,LEGAL_NAME,NAME,ADDRESS_1,ADDRESS_2,CITY,PROVINCE,POSTAL_CODE,COUNTRY,EMAIL_ADDRESS,BUSINESS_PHONE,FAX_PHONE,CDF.TYPE_OF_BUSINESS,DUNS_ID,BILL_CUSTOMER,M_USE,M_ALT_ADDRESS_1,M_ALT_ADDRESS_2,M_ALT_CITY,M_ALT_PROVINCE,' +'M_ALT_POSTAL_CODE,M_ALT_COUNTRY,CDF.SERVICE_DESC,S_USE,SHIP.ADDRESS_1,SHIP.ADDRESS_2,SHIP.CITY,SHIP.PROVINCE,SHIP.POSTAL_CODE,SHIP.COUNTRY,SHIP.EMAIL_ADDRESS,SHIP.BUSINESS_PHONE,SHIP.FAX_PHONE,OPEN_TIME_CLOSE_TIME,CBTAX_1,CDF.BUS_IND,OP_SINCE,' + 'SALES_REP,STATEMENT_DELIVERY,STATUS_1,POD_REQUIRED,CONTACT,PCP.EMAIL,PCP.PHONENUMBER,PCP.FAX_NUM,ALT_CONTACT,PCC.EMAIL,PCC.PHONENUMBER';
